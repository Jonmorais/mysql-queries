...
-- Exercício 2 : 
-- Procurando Nemo foi aclamado pela crítica! 
-- Foi classificado em 6.8, 
...
-- Exercício 4 :
-- O título do filme "Ratatouille" esta escrito
-- de forma incorreta na tabela Movies, 
...
-- Monsters SA, classificado em 8.5,
-- lucrou 300 milhões no mercado interno e 250 milhões no mercado internacional.
-- Os Incríveis, classificado em 7.4,
-- lucrou 460 milhões no mercado interno e 510 milhões no mercado internacional.
-- WALL-E, classificado em 9.9,
-- lucrou 290 milhões no mercado interno e 280 milhões no mercado internacional.

INSERT INTO `Pixar`.`BoxOffice`
    (movie_id, rating, domestic_sales, international_sales)
VALUES
    (15, 8.5, 300000000, 250000000),
